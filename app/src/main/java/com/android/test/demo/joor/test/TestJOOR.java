...
import com.android.test.demo.joor.ReflectException;
...
public class TestJOOR {
    ...
    public static void test(Context context) {
        TestJOOR testJOOR = new TestJOOR(context);
        testJOOR.test1();
    }
    ...
    private TestJOOR(Context context) {
        mContext = context;
    }
    ...
    private void test1() {
         ...
         * 4、修改private 属性
         */
        TestJOOR.TestField testField = new TestJOOR.TestField();
         ...
         * 5、修改static属性
         */
        final int sInit_int = Reflect.on(TestJOOR.TestField.class).get("S_INT1");
        Log.d(TAG, "sInit_int: " + sInit_int);

        Reflect obj = Reflect.on("com.android.test.demo.joor.test.TestJOOR$TestField").set("S_INT2", 500);
        Log.d(TAG, "set_sint: " + obj.field("S_INT2").get());

        /**
         * 6、复杂链式修改多个属性值
         */
        Reflect.on(testField).set("I_DATA", Reflect.on(TestJOOR.TestField.class).create())
        ...
        Map<String, Object> map = new TestJOOR.TestBean();
        ...
        final int height = Test.getStatusBarHeight(mContext);
    ...
    public static class TestField {
         ...
         * object
         */
        private TestJOOR.TestField I_DATA;
