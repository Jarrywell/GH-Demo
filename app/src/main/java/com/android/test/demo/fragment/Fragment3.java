...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        root.setBackgroundColor(0x550000ff);

        root.findViewById(R.id.btn_add_fragment).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /**
                 * 弹出fragment2,会导致fragment3也会弹出，回到fragment1
                 */
                getFragmentManager().popBackStack("f2-stack", FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        });
